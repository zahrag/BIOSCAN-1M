...
Subsequently, for Order-level classification utilizing the resized and cropped images of the BIOSCAN-1M Insect dataset, 
...
specifically for Order-level classification involving resized and cropped images from the BIOSCAN-1M Insect dataset, 
